...
const MODULES: ModuleInfo[] = [
  ...
  { key: 'supply-inventory', name: 'Supply & Inventory', blurb: 'Lots with DB-enforced available/reserved/allocated — never oversell (ADR-001).', status: 'planned' },
  { key: 'auction-market', name: 'Auction & Market', blurb: 'Auction lots, immutable bids and results, price snapshots.', status: 'planned' },
  { key: 'order-allocation', name: 'Order & Allocation', blurb: 'Orders, row-locked lot allocations, immutable status history.', status: 'planned' },
  { key: 'quality-traceability', name: 'Quality & Traceability', blurb: 'QC results, certificates, lot genealogy, chain of custody.', status: 'planned' },
  { key: 'logistics-coldchain', name: 'Logistics & Cold Chain', blurb: 'Shipments, temperature excursions with HOLD gating (ADR-002).', status: 'planned' },
  { key: 'payments-settlement', name: 'Payments & Settlement', blurb: 'Invoices, immutable settlements, irreversible payouts (ADR-003/004).', status: 'planned' },
  { key: 'claims-support', name: 'Claims & Support', blurb: 'Post-settlement claims, evidence, decisions, tickets.', status: 'planned' },
  { key: 'notifications', name: 'Notifications', blurb: 'Versioned templates, web push now, FCM/APNs later (ADR-006).', status: 'planned' },
  { key: 'analytics-controltower', name: 'Analytics & Control Tower', blurb: 'KPI definitions, snapshots, control-tower alerts.', status: 'planned' }
];
